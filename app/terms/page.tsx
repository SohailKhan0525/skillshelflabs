...
export default function Terms() {
  ...
  <section className="shell content-grid"><article>
    ...
    <h2>6. Moderation and removal</h2><p>SkillShelf may unpublish or remove a listing that is misleading, unauthorized, unsafe, malicious, abusive, or materially inconsistent with these terms.</p>
