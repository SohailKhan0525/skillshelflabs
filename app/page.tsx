...
export default async function Home(){
  const {data:skills=[]}=await supabase.from("skills").select("slug,name,description,category,ai_tool").eq("status","published").order("created_at",{ascending:false}).limit(6);
